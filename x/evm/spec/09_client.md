...
Find below a list of `pointguardd` commands added with the `x/evm` module. You can obtain the full list by using the `pointguardd -h` command.
...
```go
pointguardd query evm code [address] [flags]
```

```bash
# Example
$ pointguardd query evm code 0x7bf7b17da59880d9bcca24915679668db75f9397
...
```bash
pointguardd query evm storage [address] [key] [flags]
```

```bash
# Example
$ pointguardd query evm storage 0x0f54f47bf9b8e317b214ccd6a7c3e38b893cd7f0 0 --height 0
...
```bash
pointguardd tx evm raw [tx-hex] [flags]
```

```bash
# Example
$ pointguardd tx evm raw 0xf9ff74c86aefeb5f6019d77280bbb44fb695b4d45cfe97e6eed7acd62905f4a85034d5c68ed25a2e7a8eeb9baf1b84
