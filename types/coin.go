...
// NewFuryCoin is a utility function that returns an "axfury" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewFuryCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoFury, amount)
}

// NewFuryDecCoin is a utility function that returns an "axfury" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewFuryDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoFury, amount)
}

// NewFuryCoinInt64 is a utility function that returns an "axfury" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
