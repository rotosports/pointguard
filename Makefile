...
PACKAGE_NAME:=github.com/rotosports/pointguard
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/rotosports/pointguard/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/rotosports/pointguard/tests/importer
