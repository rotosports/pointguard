...
def test_native_tx_priority(ethermint: Pointguard):
    ...
    test_cases = [
        {
            ...
            "amount": "1000axfury",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}axfury",
        ...
        },
        {
            ...
            "amount": "1000axfury",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}axfury",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("axfury"))
