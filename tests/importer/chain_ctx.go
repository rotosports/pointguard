...
// transactions. There should only be a single implementation in Pointguard. For
// the purposes of Pointguard, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: Pointguard will distribute the fees out to validators, so the structure
